// ignore_for_file: avoid_returning_null_for_void, avoid_print, non_constant_identifier_names, must_be_immutable, file_names
...
class NewContract extends StatelessWidget {
  ...
  Future<void> msDetails() async {
    ...
    sh.getString('key');
    DocumentSnapshot msDocument = await FirebaseFirestore.instance
        .collection(sh.getString('key') ?? "")
        .doc('milkSociety')
